...
abstract class File implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Upload\\Model\\Map\\FileTableMap';
    ...
    /**
     * The value for the transform field.
     *
     * @var        string
     */
    protected $transform;
    ...
    /**
     * The value for the compressed_at field.
     *
     * @var        DateTime
     */
    protected $compressed_at;
    ...
    /**
     * Get the [transform] column value.
     *
     * @return string
     */
    ...
    /**
     * Get the [optionally formatted] temporal [compressed_at] column value.
     *
     *
     * @param      string|null $format The date/time format string (either date()-style or strftime()-style).
     *                            If format is NULL, then the raw DateTime object will be returned.
     ...
     * @throws PropelException - if unable to parse/validate the date/time value.
     */
    public function getCompressedAt($format = NULL)
    {
        if ($format === null) {
            return $this->compressed_at;
        } else {
            return $this->compressed_at instanceof \DateTimeInterface ? $this->compressed_at->format($format) : null;
        }
    }
    ...
    public function setExtension($v)
    {
        ...
        if ($this->extension !== $v) {
            $this->extension = $v;
            $this->modifiedColumns[FileTableMap::COL_EXTENSION] = true;
        }
    ...
    public function setDigest($v)
    {
        ...
        if ($this->digest !== $v) {
            $this->digest = $v;
            $this->modifiedColumns[FileTableMap::COL_DIGEST] = true;
        }
    ...
    /**
     * Sets the value of the [is_image] column.
    ...
    public function setIsImage($v)
    {
        ...
        if ($this->is_image !== $v) {
            $this->is_image = $v;
            $this->modifiedColumns[FileTableMap::COL_IS_IMAGE] = true;
        }
    ...
    public function setContentType($v)
    {
        ...
        if ($this->content_type !== $v) {
            $this->content_type = $v;
            $this->modifiedColumns[FileTableMap::COL_CONTENT_TYPE] = true;
        }
    ...
    public function setDir($v)
    {
        ...
        if ($this->dir !== $v) {
            $this->dir = $v;
            $this->modifiedColumns[FileTableMap::COL_DIR] = true;
        }
    ...
    public function setTransform($v)
    {
        ...
        if ($this->transform !== $v) {
            $this->transform = $v;
            $this->modifiedColumns[FileTableMap::COL_TRANSFORM] = true;
        }
    ...
    public function setSourceId($v)
    {
        ...
        if ($this->source_id !== $v) {
            $this->source_id = $v;
            $this->modifiedColumns[FileTableMap::COL_SOURCE_ID] = true;
        }
    ...
    public function setPickedAt($v)
    {
        ...
        if ($this->picked_at !== null || $dt !== null) {
            if ($this->picked_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->picked_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[FileTableMap::COL_PICKED_AT] = true;
            }
    ...
    /**
     * Sets the value of [compressed_at] column to a normalized version of the date/time value specified.
     *
     * @param  mixed $v string, integer (timestamp), or \DateTimeInterface value.
     *               Empty strings are treated as NULL.
     * @return $this|\Upload\Model\File The current object (for fluent API support)
     */
    public function setCompressedAt($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->compressed_at !== null || $dt !== null) {
            if ($this->compressed_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->compressed_at->format("Y-m-d H:i:s.u")) {
                $this->compressed_at = $dt === null ? null : clone $dt;
                $this->modifiedColumns[FileTableMap::COL_COMPRESSED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : FileTableMap::translateFieldName('Extension', TableMap::TYPE_PHPNAME, $indexType)];
            $this->extension = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : FileTableMap::translateFieldName('Digest', TableMap::TYPE_PHPNAME, $indexType)];
            $this->digest = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : FileTableMap::translateFieldName('IsImage', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_image = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : FileTableMap::translateFieldName('ContentType', TableMap::TYPE_PHPNAME, $indexType)];
            $this->content_type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : FileTableMap::translateFieldName('Dir', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dir = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : FileTableMap::translateFieldName('Transform', TableMap::TYPE_PHPNAME, $indexType)];
            $this->transform = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : FileTableMap::translateFieldName('SourceId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->source_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : FileTableMap::translateFieldName('PickedAt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->picked_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : FileTableMap::translateFieldName('CompressedAt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->compressed_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : FileTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 13; // 13 = FileTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Upload\\Model\\File'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if (null === $this->id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('file_id_seq')");
        ...
        if ($this->isColumnModified(FileTableMap::COL_EXTENSION)) {
            $modifiedColumns[':p' . $index++]  = 'extension';
        }
        if ($this->isColumnModified(FileTableMap::COL_DIGEST)) {
            $modifiedColumns[':p' . $index++]  = 'digest';
        }
        if ($this->isColumnModified(FileTableMap::COL_IS_IMAGE)) {
            $modifiedColumns[':p' . $index++]  = 'is_image';
        }
        if ($this->isColumnModified(FileTableMap::COL_CONTENT_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'content_type';
        }
        if ($this->isColumnModified(FileTableMap::COL_DIR)) {
            $modifiedColumns[':p' . $index++]  = 'dir';
        }
        if ($this->isColumnModified(FileTableMap::COL_TRANSFORM)) {
            $modifiedColumns[':p' . $index++]  = 'transform';
        }
        if ($this->isColumnModified(FileTableMap::COL_SOURCE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'source_id';
        }
        if ($this->isColumnModified(FileTableMap::COL_PICKED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'picked_at';
        }
        if ($this->isColumnModified(FileTableMap::COL_COMPRESSED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'compressed_at';
        }
        if ($this->isColumnModified(FileTableMap::COL_CREATED_AT)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'extension':
                        ...
                        break;
                    case 'digest':
                        $stmt->bindValue($identifier, $this->digest, PDO::PARAM_STR);
                        break;
                    case 'is_image':
                        $stmt->bindValue($identifier, $this->is_image, PDO::PARAM_BOOL);
                        break;
                    case 'content_type':
                        $stmt->bindValue($identifier, $this->content_type, PDO::PARAM_STR);
                        break;
                    case 'dir':
                        $stmt->bindValue($identifier, $this->dir, PDO::PARAM_STR);
                        break;
                    case 'transform':
                        $stmt->bindValue($identifier, $this->transform, PDO::PARAM_STR);
                        break;
                    case 'source_id':
                    ...
                    case 'picked_at':
                        ...
                        break;
                    case 'compressed_at':
                        $stmt->bindValue($identifier, $this->compressed_at ? $this->compressed_at->format("Y-m-d H:i:s.u") : null, PDO::PARAM_STR);
                        break;
                    case 'created_at':
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[3] => $this->getDigest(),
            $keys[4] => $this->getIsImage(),
            $keys[5] => $this->getContentType(),
            $keys[6] => $this->getDir(),
            $keys[7] => $this->getTransform(),
            $keys[8] => $this->getSourceId(),
            $keys[9] => $this->getPickedAt(),
            $keys[10] => $this->getCompressedAt(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->collFilesRelatedById) {
                ...
                $result[$key] = $this->collFilesRelatedById->toArray(null, false, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
        }
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setExtension($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setDigest($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setIsImage($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setContentType($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setDir($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setTransform($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setSourceId($arr[$keys[8]]);
        }
        if (array_key_exists($keys[9], $arr)) {
            $this->setPickedAt($arr[$keys[9]]);
        }
        if (array_key_exists($keys[10], $arr)) {
            $this->setCompressedAt($arr[$keys[10]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Upload\Model\File The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FileTableMap::COL_EXTENSION)) {
            $criteria->add(FileTableMap::COL_EXTENSION, $this->extension);
        }
        if ($this->isColumnModified(FileTableMap::COL_DIGEST)) {
            $criteria->add(FileTableMap::COL_DIGEST, $this->digest);
        }
        if ($this->isColumnModified(FileTableMap::COL_IS_IMAGE)) {
            $criteria->add(FileTableMap::COL_IS_IMAGE, $this->is_image);
        }
        if ($this->isColumnModified(FileTableMap::COL_CONTENT_TYPE)) {
            $criteria->add(FileTableMap::COL_CONTENT_TYPE, $this->content_type);
        }
        if ($this->isColumnModified(FileTableMap::COL_DIR)) {
            $criteria->add(FileTableMap::COL_DIR, $this->dir);
        }
        if ($this->isColumnModified(FileTableMap::COL_TRANSFORM)) {
            $criteria->add(FileTableMap::COL_TRANSFORM, $this->transform);
        }
        if ($this->isColumnModified(FileTableMap::COL_SOURCE_ID)) {
            $criteria->add(FileTableMap::COL_SOURCE_ID, $this->source_id);
        }
        if ($this->isColumnModified(FileTableMap::COL_PICKED_AT)) {
            $criteria->add(FileTableMap::COL_PICKED_AT, $this->picked_at);
        }
        if ($this->isColumnModified(FileTableMap::COL_COMPRESSED_AT)) {
            $criteria->add(FileTableMap::COL_COMPRESSED_AT, $this->compressed_at);
        }
        if ($this->isColumnModified(FileTableMap::COL_CREATED_AT)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Upload\Model\File (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setTransform($this->getTransform());
        $copyObj->setSourceId($this->getSourceId());
        $copyObj->setPickedAt($this->getPickedAt());
        $copyObj->setCompressedAt($this->getCompressedAt());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Upload\Model\File Clone of current object.
     * @throws PropelException
     */
     ...
     * @throws PropelException
     */
    public function setSource(ChildFile $v = null)
    {
        if ($v === null) {
    ...
    public function getSource(ConnectionInterface $con = null)
    {
        if ($this->aSource === null && ($this->source_id != 0)) {
            $this->aSource = ChildFileQuery::create()->findPk($this->source_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSource->addFilesRelatedById($this);
             */
        }
    ...
    public function initFilesRelatedById($overrideExisting = true)
    {
        ...
        $this->collFilesRelatedById = new $collectionClassName;
        $this->collFilesRelatedById->setModel('\Upload\Model\File');
    }
     ...
     *
     * @param      Collection $filesRelatedById A Propel collection.
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildFile The current object (for fluent API support)
     */
    public function setFilesRelatedById(Collection $filesRelatedById, ConnectionInterface $con = null)
    {
        /** @var ChildFile[] $filesRelatedByIdToDelete */
        ...
        foreach ($filesRelatedByIdToDelete as $fileRelatedByIdRemoved) {
            $fileRelatedByIdRemoved->setSource(null);
        }
     ...
     * @throws PropelException
     */
    public function countFilesRelatedById(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collFilesRelatedByIdPartial && !$this->isNew();
        if (null === $this->collFilesRelatedById || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collFilesRelatedById) {
     ...
     * @return $this|\Upload\Model\File The current object (for fluent API support)
     */
    public function addFileRelatedById(ChildFile $l)
    {
        if ($this->collFilesRelatedById === null) {
            $this->initFilesRelatedById();
            $this->collFilesRelatedByIdPartial = true;
        ...
        if (!$this->collFilesRelatedById->contains($l)) {
    ...
    /**
     * @param ChildFile $fileRelatedById The ChildFile object to add.
     */
    protected function doAddFileRelatedById(ChildFile $fileRelatedById)
    {
        $this->collFilesRelatedById[]= $fileRelatedById;
        $fileRelatedById->setSource($this);
    }

    /**
     * @param  ChildFile $fileRelatedById The ChildFile object to remove.
     * @return $this|ChildFile The current object (for fluent API support)
     */
    public function removeFileRelatedById(ChildFile $fileRelatedById)
    {
        if ($this->getFilesRelatedById()->contains($fileRelatedById)) {
            $pos = $this->collFilesRelatedById->search($fileRelatedById);
            $this->collFilesRelatedById->remove($pos);
            ...
            $fileRelatedById->setSource(null);
        }
    ...
    {
        if (null !== $this->aSource) {
            $this->aSource->removeFileRelatedById($this);
        }
        $this->id = null;
        $this->name = null;
        $this->extension = null;
